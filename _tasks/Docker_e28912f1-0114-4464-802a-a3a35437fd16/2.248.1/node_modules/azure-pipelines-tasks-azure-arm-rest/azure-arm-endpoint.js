...
class AzureRMEndpoint {
    ...
    getEndpoint(useGraphActiveDirectoryResource = false, useMSAL = false) {
            ...
            if (!!this.endpoint) {
                ...
                if (endpointAuthScheme && endpointAuthScheme.toLowerCase() == constants.AzureRmEndpointAuthenticationScheme.PublishProfile) {
                    ...
                    if (useGraphActiveDirectoryResource) {
                        ...
                        var activeDirectoryResourceId = tl.getEndpointDataParameter(this._connectedServiceName, useMSAL ? 'microsoftGraphUrl' : 'graphUrl', true);
