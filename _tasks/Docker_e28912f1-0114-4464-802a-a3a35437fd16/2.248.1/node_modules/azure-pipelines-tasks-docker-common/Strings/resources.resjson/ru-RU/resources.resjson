{
  ...
  "loc.messages.OldDockerConfigContent": "Найдено более раннее имя для входа для того же реестра. Идет сохранение старых данных проверки подлинности и продолжение работы с новым именем для входа. Старая конфигурация Docker: %s",
